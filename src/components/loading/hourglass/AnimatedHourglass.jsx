...
function AnimatedHourglass({ s }) {
    const size = s ? `${s}px` : '40px';

    return (
        <div id='hourglass-container'>
            <svg width={size} viewBox="0 0 73 88" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                <g id="hourglass">
                    ...
                    <rect id="top-plate" fill="#00319c" x="0" y="0" width="74" height="8" rx="2"></rect>
                    <rect id="bottom-plate" fill="#00319c" x="0" y="80" width="74" height="8" rx="2"></rect>
                    ...
                    <g id="top-sand" transform="translate(18, 21)">
                        ...
                        <path fill="#698edf" clipPath="url(#top-clip-path)" d="M38,0 C36.218769,7.51704545 24.818769,21 19,21 C13.418769,21 1.9,7.63636364 0,0 L38,0 Z"></path>
                    </g>
                    ...
                    <g id="bottom-sand" transform="translate(18, 55)">
                        ...
                        <g clipPath="url(#bottom-clip-path)">
                            <path fill="#698edf" d="M0,21 L38,21 C36.1,13.3636364 24.581231,0 19,0 C13.181231,0 1.781231,13.4829545 0,21 Z"></path>
                        </g>
                    </g>
                </g>
            </svg>
